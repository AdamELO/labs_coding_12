...
@section('content')
<h2 class="text-center">Banner carousel</h2>
    <div class="">
        ...
        <div class="row">
            ...
            @endforeach
                ...
                <div class="row">
                    <div class="col-8">
                        <h2 class="text-left mb-2">Logo :</h2>
                        @if (Storage::disk('public')->has($menus->logo))
                        <img width="150px" src={{asset('storage/'.$menus->logo)}} alt=""><!-- Logo -->
                        @else
                        <img width="150px" src="{{$menus->logo}}" alt=""><!-- Logo -->
                        @endif
