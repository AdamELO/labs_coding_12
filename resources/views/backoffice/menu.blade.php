        ...
        <div class="row">
            ...
            <div class="col-md-12 mb-md-0 mb-5">
                <form id="contact-form" class="container"
                    action='{{ route('menu.update',$menus->id) }}' method="post" enctype="multipart/form-data" >
                    @csrf
                    @method('put')
                    <!--Grid row-->
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="md-form mb-0">
                                <input type="text" value="{{$menus->lien1}}" id="email" name="lien1" class="form-control">
                                <label for="email" class="">Lien 1 </label>
                            </div>
                        </div>
                        <div class=" col-md-6">
                            <div class="md-form mb-0">
                                <input type="text" value="{{$menus->lien2}}" id="email" name="lien2" class="form-control">
                        ...
                        <div class="col-md-6">
                            <div class="md-form mb-0">
                                <input type="text" value="{{$menus->lien3}}" id="email" name="lien3" class="form-control">
                                <label for="email" class="">Lien 3 </label>
                            </div>
                        </div>
                        <div class=" col-md-6">
                            <div class="md-form mb-0">
                                <input type="text" value="{{$menus->lien4}}" id="email" name="lien4" class="form-control">
